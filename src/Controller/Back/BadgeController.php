...
{
    /**
     * @Route("/", name="app_back_badge_index", methods={"GET"})
     */
    public function index(BadgeRepository $badgeRepository): Response
    {
        return $this->render('back/badge/index.html.twig', [
     ...
     * @Route("/new", name="app_back_badge_new", methods={"GET", "POST"})
     */
    public function new(Request $request, BadgeRepository $badgeRepository): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('app_back_badge_index', [], Response::HTTP_SEE_OTHER);
        }

        return $this->renderForm('back/badge/new.html.twig', [
            'badge' => $badge,
            'form' => $form,
        ]);
    }
    ...
    /**
     * @Route("/{id}", name="app_back_badge_show", methods={"GET"})
     */
    ...
    /**
     * @IsGranted("ROLE_ADMIN") 
     * @Route("/{id}/edit", name="app_back_badge_edit", methods={"GET", "POST"})
     */
    public function edit(Request $request, Badge $badge, BadgeRepository $badgeRepository): Response
    {
        ...
        return $this->renderForm('back/badge/edit.html.twig', [
            'badge' => $badge,
            'form' => $form,
        ]);
    }
    ...
    /**
     * @IsGranted("ROLE_ADMIN") 
     * @Route("/{id}", name="app_back_badge_delete", methods={"POST"})
     */
